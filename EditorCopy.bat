cd..
cd..
xcopy .\AR41Editor\Include\GameObject\*.* .\Client2D\Include\GameObject\ /d /s /y
...
xcopy .\AR41Editor\Include\Skill\*.* .\Client2D\Include\Skill\ /d /s /y /exclude:EditorExclude.txt
